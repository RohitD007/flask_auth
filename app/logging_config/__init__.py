...
@log_con.before_app_request
def rohit_debug_func():
    log = logging.getLogger("rohitrequest")
    log.debug("rohit DEBUG message")


@log_con.before_app_request
def kw_request_func():
    log = logging.getLogger("request")
    log.debug("KW request message")
...
LOGGING_CONFIG = {
    ...
    'loggers': {
        ...
        'rohitrequest': {  # if __name__ == '__main__'
            'handlers': ['file.handler.rohitrequest'],
            'level': 'DEBUG',
            'propagate': False
        },
